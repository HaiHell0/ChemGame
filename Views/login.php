      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            <h1>Login with</h1>
            <button type="button" class="btn btn-primary"><a href="adminLogin.php" class="text-white-50 fw-bold">Admin</a></button>
            <button type="button" class="btn btn-primary"><a href="userLogin.php" class="text-white-50 fw-bold">User</a></button>
            <br>
            <h3>or</h3>
            <br >
